...
@if(stripos($field->title, 'phone') !== false || stripos($field->title, 'mobile') !== false || stripos($field->title, 'telephone') !== false || stripos($field->title, 'phone') !== false || stripos($field->title, 'fax') !== false)
<div class="form-group">
    <label class="input-label" for="code">{{ $field->title }}: @if($isRequired)<span style="color: red;">*</span>@endif</label>
    <div class="row">
        <div class="col-md-5">
        ...
        <div class="col-md-7">
            <input type="text" maxlength="15" name="mobile" class="form-control @error($field->id) is-invalid @enderror" value="{{ (!empty($values) and !empty($values[$field->id])) ? $values[$field->id] : old('fields.'.$field->id) }}" onkeypress="return event.charCode >= 48 && event.charCode <= 57">
            @error($field->id)
...
<div class="form-group">
    <label class="input-label">{{ $field->title }} @if($isRequired)<span style="color: red;">*</span>@endif</label>
...
<div class="mb-20">
    <div class="d-flex align-items-center ">
        <label class="mb-0 mr-10 cursor-pointer" for="toggle{{ $field->id }}">{{ $field->title }} @if($isRequired)<span style="color: red;">*</span>@endif</label>
