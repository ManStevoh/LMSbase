            ...
            <div class="profile-info-box d-flex align-items-start justify-content-between">
                <div class="user-details d-flex align-items-center">
                    ...
                    <div class="ml-20 ml-lg-40">
                        <h1 class="font-24 font-weight-bold text-dark-blue">{{ $user->full_name . ' ' . $user->middle_name . ' ' . $user->last_name }}</h1>
                ...
                <div class="user-actions d-flex flex-column">
                    @auth
                        ...
                        @endif
                    @else
                        <a href="{{ route('login') }}" class="btn btn-primary btn-sm">{{ trans('panel.follow') }}</a>

                        @if($user->public_message)
                            <a href="{{ route('login') }}" class="btn btn-border-white rounded btn-sm mt-15">{{ trans('site.send_message') }}</a>
                        @endif
                    @endauth
                </div>
            </div>
