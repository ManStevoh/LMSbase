...
@section('content')
    <section class="site-top-banner search-top-banner opacity-04 position-relative">
        <img src="{{ getPageBackgroundSettings('classes') }}" class="img-cover" alt=""/>
    ...
    <div class="container mt-30">
        <section class="mt-lg-50 pt-lg-20 mt-md-40 pt-md-40">
            <form action="/classes" method="get" id="filtersForm">
                ...
                <div class="row mt-20">
                    <div class="col-12 {{ config('settings.hide_course_filters') != 'yes' ? 'col-lg-8' : '' }}">
                    ...
                    @if(config('settings.hide_course_filters') != 'yes')
