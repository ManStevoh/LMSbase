                        ...
                        @if (!empty($cities))
                            @foreach ($cities as $city)
                                ...
                                <option value="{{ $city->id }}"
                                    data-center="{{ implode(',', $city->geo_center) }}"
            ...
            <table class="table text-center custom-table">
                <thead>
                    ...
                    @if (config('settings.use_age_field') == 'yes')
                        <th class="text-center">{{ trans('update.age') }}</th>
                    @endif
                    @if (config('settings.use_msme_sector') == 'yes')
                        <th class="text-center">{{ trans('update.msme_sector') }}</th>
                    @endif
                    <th class="text-center">{{ trans('update.nationality') }}</th>
                    @if (config('settings.use_lga_field') == 'yes')
                        <th class="text-center">{{ trans('update.lga') }}</th>
                    @endif
                    ...
                    @if (!empty($userLoginHistories))
                        ...
                        @foreach ($userLoginHistories as $session)
                            <tr>
                                ...
                                @endif
                                @if (config('settings.use_msme_sector') == 'yes')
                                    <td class="text-center">{{ $user->msme_sector ?? '-' }}</td>
                                @endif
                                <td class="text-center">{{ $user->nationality ?? '-' }}</td>

                                @if (config('settings.use_lga_field') == 'yes')
                                    <td class="text-center">{{ $user->lga ?? '-' }}</td>
                                @endif
                                <td class="text-center">{{ dateTimeFormat($session->session_start_at, 'j M Y H:i') }}
                                </td>
