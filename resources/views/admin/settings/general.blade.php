                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <ul class="nav nav-pills" id="myTab3" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link @if(!empty($app_settings)) active @endif" id="settings-tab" data-toggle="tab" href="#app-settings" role="tab" aria-controls="socials" aria-selected="true">App Settings</a>
                                </li>
                            ...
                            <div class="tab-content" id="myTabContent2">
                                ...
                                @include('admin.settings.general.settings',['itemValue' => (!empty($settings) and !empty($settings['app_settings'])) ? $settings['app_settings']->value : '', 'social' => $app_setting ?? null, 'socialKey' => $socialKey ?? null])
