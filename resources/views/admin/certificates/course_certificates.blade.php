                            ...
                            <div class="table-responsive">
                                <table class="table table-striped font-14">
                                    <tr>
                                        ...
                                        <th class="text-left">Instuctor email</th>
                                    ...
                                    @foreach($certificates as $certificate)
                                        <tr>
                                            ...
                                            <td class="text-left">{{ $certificate->student->full_name . ' ' . $certificate->student->middle_name . ' ' . $certificate->student->last_name }}</td>
                                            
                                            <td class="text-left">{{ $certificate->student->email }}</td>
                                            ...
                                            <td class="text-left">
                                                @if(!empty($certificate->webinar_id))
                                                    {{ $certificate->webinar->teacher->email }}
                                                @else
                                                    {{ $certificate->bundle->teacher->email }}
                                                @endif
                                            </td>
