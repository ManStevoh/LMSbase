<div class="main-sidebar">
    <aside id="sidebar-wrapper">
        ...
        <div class="sidebar-search">
            <input type="text" id="sidebar-search-input" class="form-control" placeholder="Search the menu...">
        </div>
        ...
        <ul id="sidebar-menu" class="sidebar-menu">
            ...
            <li class="{{ (request()->is(getAdminPanelUrl('/academy', false))) ? 'active' : '' }}">
                <a href="{{ getAdminPanelUrl('/academy') }}" class="nav-link">
            ...
            <li class="nav-item dropdown {{ (request()->is(getAdminPanelUrl('/staffs', false)) or request()->is(getAdminPanelUrl('/students', false)) or request()->is(getAdminPanelUrl('/instructors', false)) or request()->is(getAdminPanelUrl('/organizations', false))) ? 'active' : '' }}">
                ...
                <ul class="dropdown-menu">
                    ...
                    @can('admin_users_create')
                    <li class="{{ (request()->is(getAdminPanelUrl('/users/bulk', false))) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/users/bulk">Bulk Import</a>
                    </li>
                    @endcan()
            ...
            <li class="nav-item dropdown {{ (request()->is(getAdminPanelUrl('/reports*', false)) or request()->is(getAdminPanelUrl('/comments/webinars/reports', false)) or request()->is(getAdminPanelUrl('/comments/blog/reports', false))) ? 'active' : '' }}">
                ...
                <ul class="dropdown-menu">
                    ...
                    @can('admin_report_reasons')
                    <li class="{{ (request()->is(getAdminPanelUrl('/reports/all-user-data', false))) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/reports/all-user-data">{{ __('All User Data') }}</a>
                    </li>
                    <li class="{{ (request()->is(getAdminPanelUrl('/reports/user-activities', false))) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/reports/user-activities">{{ __('User Activities') }}</a>
                    </li>

                    <li class="{{ (request()->is(getAdminPanelUrl('/reports/course-certificates', false))) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/reports/course-certificates">{{ __('Course Certificates') }}</a>
                    </li>

                    <li class="{{ (request()->is(getAdminPanelUrl('/reports/issued-certificates', false))) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/reports/issued-certificates">{{ __('Issued Certificates') }}</a>
                    </li>
                    @endcan()
                </ul>
            </li>
