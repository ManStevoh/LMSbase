...
Route::group(['prefix' => $prefix, 'namespace' => 'Admin', 'middleware' => ['web', 'admin_locale']], function () use ($prefix) {
    ...
    Route::get('/admin/states/{state}/lgas', [App\Http\Controllers\Admin\UserController::class, 'getLgasByState'])
    ->name('admin.states.lgas');
    ...
    Route::get('/users/search', 'NotificationsController@search')->name('admin.users.search');
    ...
    Route::group(['middleware' => 'admin'], function () {
        ...
        Route::group(['prefix' => 'academy'], function () {
            Route::get('/', 'DashboardController@academy');
            Route::post('/getEnrollmentsChart', 'DashboardController@getEnrollmentsChartAjax');
            Route::post('/getCertChart', 'DashboardController@getNetCertChartAjax');
        });
        ...
        Route::group(['prefix' => 'students'], function () {
            ...
            Route::post('/upload-students', 'UserController@studentBulkImport')->name('admin.studentbulkupload');
        });
        ...
        Route::group(['prefix' => 'users'], function () {
            ...
            // hapa new bulk users import
            Route::post('/import/bulk', 'UserController@importBulk')->name('import');


            Route::get('/bulk', 'UserController@bulk');
        ...
        Route::group(['prefix' => 'reports'], function () {
            ...
            Route::get('user-activities', 'ReportsController@userActivity')->name('useractivity');
            Route::post('user-activities', 'ReportsController@userActivity')->name('useractivity');

            Route::get('user-activities/excel-export', 'ReportsController@userActivityExport');

            Route::get('course-certificates', 'ReportsController@courseCertificate');
            Route::post('course-certificates', 'ReportsController@courseCertificate');

            Route::get('issued-certificates', 'ReportsController@issuedCertificates');
            Route::post('issued-certificates', 'ReportsController@issuedCertificates');

            Route::get('all-user-data', 'ReportsController@allUserData');
            Route::post('all-user-data', 'ReportsController@allUserData');
        ...
        Route::group(['prefix' => 'settings'], function () {
            ...
            Route::group(['prefix' => '/app-settings'], function () {
                Route::post('/store', 'SettingsController@storeAppSettings');
                Route::get('/{key}/edit', 'SettingsController@editAppSettings');
                Route::get('/{key}/delete', 'SettingsController@editAppSettings');
            });
        ...
        Route::group(['prefix' => 'enrollments'], function () {
            ...
            Route::get('/bulk', 'EnrollmentController@addBulkStudentToCourse');
            ...
            Route::post('/bulk-student-enrollment', 'EnrollmentController@bulkStudentEnrollment')->name('admin.bulkstudentenrollment');
        });
