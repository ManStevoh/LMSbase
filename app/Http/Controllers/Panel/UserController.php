...
class UserController extends Controller
{
    ...
    public function setting(Request $request, $step = 1)
    {
        ...
        $data = [
            ...
            'age' => $age,
            'msme_sector' => $msme_sector,
            'nationality' => $nationality,
            'lga' => $lga,
        ];

        return view('web.default.panel.setting.index', $data);
        ...
        if (!empty($user)) {
            ...
            if ($step == 1) {
                ...
                $updateData = [
                    ...
                    'msme_sector' => $data['msme_sector'] ?? null,
