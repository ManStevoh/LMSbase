...
class EnrollmentController extends Controller
{
    ...
    public function bulkStudentEnrollment(Request $request){
        $this->authorize('admin_users_create');
        $request->validate([
            'file' => ['required']
        ]);
        try {
            Excel::import(new StudentBulkEnrollment(), $request->file('file'));
        ...
        public function addBulkStudentToCourse()
    {
        $this->authorize('admin_enrollment_add_student_to_items');
        ...
        return view('admin.enrollment.enroll_bulk', $data);
    }
