...
class MakeCertificate
{
    ...
    private function makeBody($template, $userCertificate, $user, $body, $courseTitle = null, $userGrade = null, $teacherId = null, $teacherFullName = null, $duration = null)
    {
        ...
        //concatinate the user name
        $user_name = $user->full_name . ' ' . $user->middle_name . ' ' . $user->last_name;

        $body = str_replace('[student]', $user_name, $body);
    ...
    private function sendToApi($certificate, $html)
    {
        ...
        $userId = "518cc7e3-45c4-4d81-84fe-64d325f685d8";
        $APIKey = "7075f3d2-6ecc-4680-95bd-7e618768adbb";
        ...
        $pdf = Pdf::loadHTML($data['html'])
            ->setPaper([0, 0, $data['viewport_width'], $data['viewport_height']], 'portrait');
