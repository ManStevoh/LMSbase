    ...
    (function (e) {
        ...
        function (e, o, t) {
            ...
            function p(e, o) {
                ...
                if (
                    (void 0 !== e.fileselect &&
                        (h = c(h, "fileselect", Boolean(e.fileselect))),
                    void 0 !== e.sizeLimit &&
                        (h = c(h, "size_limit", e.sizeLimit)),
                ...
                (!1 === e.showSignOut && (h = c(h, "show_sign_out", "false")),
                ...
                e.requiredPermissions &&
                    (h = c(
                        ...
                        encodeURIComponent(
                            m(e.requiredPermissions, "join", function (e) {
                                return e.join(" ");
                            }) || ""
                        )
                    ));
                (s && (h = c(h, "product_key", s)),
                null === (t = e.suggestions) || void 0 === t
                    ? void 0
                    : t.experimentGroup) &&
                    (h = c(
                        h,
                        "suggestions_experiment_group",
                        encodeURIComponent(
                            null === (n = e.suggestions) || void 0 === n
                                ? void 0
                                : n.experimentGroup
                        )
                    ));
            ...
            function d(e) {
                var o = {
                    options: Object(s.a)(Object(s.a)({}, e), {
                        ...
                        cancel: function (t) {
                            "function" == typeof e.cancel && e.cancel(t),
                                r === o && (r = null);
                        },
                    }),
                };
            ...
            function h(e, o, t) {
                var r,
                    s = JSON.parse(e.data);
                switch (
                    ((r = null != i && t._popup ? i.contentWindow : e.source),
                    void 0 !== s.sequence_number &&
                        r.postMessage(
                            JSON.stringify({
                                method: "ack",
                    ...
                    case "ready":
                        if (null != t.files) {
                            ...
                            if (
                                (r.postMessage(a, Dropbox.baseUrl),
                                null != t._ews_auth_token)
                            ) {
                    ...
                    case "close_dialog":
                        "function" == typeof o && o(),
                            "function" == typeof t.cancel && t.cancel(n);
                        break;
                    case "resize":
            ...
            function b(e) {
                ...
                return (
                    ...
                    l(
                        ""
                            .concat(Dropbox.baseUrl, "/saver?origin=")
                            .concat(o, "&app_key=")
                            .concat(t, "&iframe=")
                            .concat(e)
                    )
            ...
            function m(e, o, t) {
                return null != e && "function" == typeof e[o]
                    ? t(e, o)
                    : void 0;
            }
            function v() {
                (n = {}),
                    ...
                    null == Dropbox.baseUrl &&
                        (Dropbox.baseUrl = "https://".concat(
                            "www.dropbox.com"
                        )),
                    null == Dropbox.blockBaseUrl &&
                        (Dropbox.blockBaseUrl = "https://".concat(
                            "dl-web.dropbox.com"
                        )),
        ...
        function (e, o, t) {
            ...
            function s(e, o, t) {
                if (t || 2 === arguments.length)
                    for (var n, i = 0, r = o.length; i < r; i++)
                        (!n && i in o) ||
                            (n || (n = Array.prototype.slice.call(o, 0, i)),
                            (n[i] = o[i]));
            ...
            function p() {
                ...
                Object(n.h)(),
                    null == Dropbox.appKey &&
                        (Dropbox.appKey =
                            null ===
                                (e = document.getElementById("dropboxjs")) ||
                            void 0 === e
                                ? void 0
                    ...
                    (Dropbox.init = function (e) {
                        null != e.appKey && (Dropbox.appKey = e.appKey),
                            null != e.productKey &&
                                (Dropbox.productKey = e.productKey);
                    });
                var o = function (e) {
                    var o, t, n;
                    if ("string" == typeof e[0])
                        (n = e.shift()),
                            (o = "string" == typeof e[0] ? e.shift() : l(n)),
                            ((t = e.shift() || {}).files = [
                                { url: n, filename: o },
                            ]);
                    else {
                        if (null == (t = e.shift()))
                            throw new Error(
                                "Missing arguments. See documentation."
                            );
                        if (
                ...
                var t = function (e, o, t) {
                        ...
                        var c = setInterval(function () {
                            (function () {
                                ...
                                (i(),
                                "function" == typeof t.cancel && t.cancel(n.i));
                        }, 100);
                        return (
                    ...
                    c = function (e) {
                        null == e.success &&
                            ...
                            void 0 === e.fileselect ||
                                ...
                                Object(n.a)(console, "error", function (e) {
                                    return e.error(
                        ...
                        var o = function () {
                            return (
                                Object(n.a)(console, "warn", function (e) {
                                    return e.warn(
                                        "The provided list of extensions or file types is not valid. See Chooser documentation: ".concat(
                                            i
                                        )
                                    );
                                }),
                                Object(n.a)(console, "warn", function (e) {
                                    return e.warn(
                                        "Available file types are: ".concat(
                                            r.join(", ")
                                        )
                                    );
                                }),
                        ...
                        if (Dropbox.isBrowserSupported()) {
                            ...
                            if (e.iframe && !e.windowName) {
                                var s =
                                    ...
                                    i);
                                (s.style.width = "735px"),
                                    (s.style.height = "552px"),
                                    (s.style.margin = "125px auto 0 auto"),
                                    (s.style.border = "1px solid #ACACAC"),
                                    (s.style.boxShadow =
                                        "rgba(0, 0, 0, .2) 0px 4px 16px");
                                ...
                                r.onClose = t(
                                    Object(n.b)(r.options, r.options.iframe),
                                    l,
                                    r.options
                                ).onClose;
                            }
                ...
                (Dropbox.choose = function (e) {
                    ...
                    (Dropbox.cancelChooser = function () {
                        n.e &&
                            (n.e.onClose && n.e.onClose(),
                            n.e.options.cancel && n.e.options.cancel(n.i));
                    }),
                    (Dropbox.getChooserExtras = function () {
                        var e;
                        return null !== (e = Dropbox.chooserExtras) &&
                            void 0 !== e
                            ? e
                            : {};
                    });
                (Dropbox.isBrowserSupported = function () {
                    var e = (function () {
                        for (
                            var e = 0, o = [/IEMobile\/(7|8|9|10)\./, /BB10;/];
                            e < o.length;
                            e++
                        ) {
                    ...
                    (Dropbox.createSaveButton = function () {
                        ...
                        var n = o(e),
                            i = e.shift();
                        return (
                            (i = a("Save to Dropbox", i)),
                            Dropbox.addListener(i, "click", function (e) {
                                if (
                                    (e.preventDefault(),
                                    i.className.indexOf(
                                        "dropbox-dropin-error"
                                    ) >= 0 ||
                                        i.className.indexOf(
                ...
                d.styleSheet ? (d.styleSheet.cssText = f) : (d.textContent = f),
                    ...
                    function e(e, o) {
                        ...
                        (this.popupWindow = e),
                            ...
                            (this.messagingWindow = function () {
                                return void 0 !== i.g && null !== i.g
                                    ? i.g.contentWindow
                                    : t.popupWindow;
                            }),
                            (this.handleInterval = function () {
                                t.isWindowClosedByUser() &&
                                    (t.onClose(), t.stopInterval());
                            }),
            ...
            var l = (function () {
                        ...
                        (this.activeDropins = []),
                            ...
                            (this.openWindow = function (o) {
                                ...
                                try {
                                    ...
                                    var u = { dropin: o, cleanup: c };
                                    e.activeDropins.push(u),
                                        (t = s([e.deleteActiveDropin(u), t])),
                                        o.hasOnCloseDialogMessage() ||
                                            o.setOnCloseDialogMessage(t),
                                        (u.cleanup = t);
                                } catch (e) {
                                    throw (t(), e);
                                }
                    ...
                    return (
                        (e.prototype.mount = function (e, o) {
                            if (!e)
                                throw new Error(
                                    "Dropbox component must be provided"
                                );
                            if (!o)
                                throw new Error(
                                    "Container element must be provided"
                                );
                            ...
                            try {
                                ...
                                var r = { dropin: e, cleanup: c };
                                this.activeDropins.push(r),
                                    (t = s([this.deleteActiveDropin(r), t])),
                                    e.hasOnCloseDialogMessage() ||
                                        e.setOnCloseDialogMessage(t),
                                    (r.cleanup = t);
                            } catch (e) {
                                throw (t(), e);
                            }
                    ...
                    return (
                        ...
                        (e.prototype.setOnCloseDialogMessage = function (e) {
                            if ("function" != typeof e)
                                throw new Error(
                                    "onCloseDialogMessage must be a function"
                                );
                        ...
                        return (
                            ...
                            (t.validateOptions = function () {
                                var e = function (e, o) {
                                    if (
                                        void 0 !== t.options[e] &&
                                        typeof t.options[e] !== o
                                    )
                                        throw new Error(
                                            "The "
                                                .concat(
                                                    e,
                                                    " option, if provided, must have type "
                                                )
                                                .concat(o)
                                        );
                                };
                                if (
                                    ...
                                    if (
                                        !(t.options.extensions instanceof Array)
                                    )
                                        throw new Error(
                                            "The extensions option, if provided, must be an array"
                                        );
                                    for (
                                        var o = 0, n = t.options.extensions;
                                        o < n.length;
                                        o++
                                    ) {
                                        var i = n[o];
                                        if (
                                            ...
                                            throw new Error(
                                                "The provided list of extensions or file types is not valid. " +
                                                    "See Chooser documentation: ".concat(
                                                        f,
                                                        ". "
                                                    ) +
                                                    "Available file types are: ".concat(
                                ...
                                if (
                                    (e("sizeLimit", "number"),
                                    void 0 !== t.options.sizeLimit &&
                                        t.options.sizeLimit <= 0)
                                )
                                    throw new Error(
                                        "The sizeLimit option, if provided, must be a positive number"
                                    );
                                ...
                                if (c) {
                                    if ("object" != typeof c)
                                        throw new Error(
                                            "The suggestions option, if provided, must be an object"
                                        );
                                    if ("string" != typeof c.experimentGroup)
                                        throw new Error(
                                            "The suggestions.experimentGroup option, if provided, must be a string"
                                        );
                                }
                                if ("function" != typeof t.options.onSuccess)
                                    throw new Error(
                                        "You must provide a success callback to the Chooser to see the files that the user selects"
                                    );
                                e("onReady", "function"),
                    ...
                    function o(o) {
                        ...
                        return (
                            ((r = e.call(this, o) || this).state = {
                                link: r.options.link,
                                file_zoom:
                                    null === (t = r.options.file) ||
                                    void 0 === t
                                        ? void 0
                                        : t.zoom,
                                folder_view:
                                    null === (n = r.options.folder) ||
                                    void 0 === n
                                        ? void 0
                                        : n.view,
                                folder_headerSize:
                                    null === (i = r.options.folder) ||
                                    void 0 === i
                                        ? void 0
                                        : i.headerSize,
                            }),
                ...
                w = (function (e) {
                        ...
                        return (
                            ...
                            (n.state = {
                                ...
                                initialFolderSelection:
                                    n.options.initialFolderSelection,
                            }),
                    ...
                    return (
                        ...
                        (o.validateOnFolderSelected = function (e) {
                            if (e && "function" != typeof e)
                                throw new Error(
                                    "onFolderSelected must be a function"
                                );
                        }),
                        (o.prototype.urlParams = function () {
                            var e = [
                            ...
                            return (
                                this.options.showFoldersOnly &&
                                    e.push({
                                        key: "show_folders_only",
                                        value: "true",
                                    }),
                                this.options.showSearchBar &&
                                    e.push({
                                        key: "show_search_bar",
                                        value: "true",
                                    }),
                            ...
                            switch (
                                ...
                                case "folder_selected":
                                    this.onFolderSelected &&
                                        this.onFolderSelected(o.params.path);
                            }
                        }),
                        (o.prototype.setEntries = function (e) {
                            (this.state = Object(n.a)(
                                Object(n.a)({}, this.state),
                                { entries: e }
                            )),
                                this.sendState();
                        }),
